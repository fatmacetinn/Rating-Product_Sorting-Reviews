...
#  Average Rating'i Güncel Yorumlara Göre Hesaplanması ve Var Olan Average Rating ile Kıyaslanması
...
# Adım 2. score_pos_neg_diff, score_average_rating ve wilson_lower_bound Skorlarını Hesaplanması ve veriye eklenmesi
